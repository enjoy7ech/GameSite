...
const games = ref<Game[]>([
  {
    id: "danqing-yizhen",
    name: "丹青遗珍",
    url: "/games/danqing-yizhen/index.html",
    color: "#d4af37",
    image: "/games/danqing-yizhen/cover.png",
    orientation: "landscape",
  },
  {
    id: "landlord",
    name: "LUCKY LANDLORD",
    url: "/games/lucky-landlord/index.html",
    color: "#ff00ea",
    image: "/games/lucky-landlord/assets/logo.png",
    orientation: "portrait",
  },
  {
    id: "mtower",
    name: "MAGIC TOWER",
    url: "/games/magic-tower/index.html",
    color: "#00fff2",
    image: "/games/magic-tower/cover.png",
    orientation: "landscape",
  },
  {
    id: "basket",
    name: "BASKET RACE 3D",
    url: "/games/basket/index.html",
    color: "#ffb700",
    image: "/games/basket/cover.png",
    orientation: "landscape",
  },
  {
    id: "pingpong",
    name: "PING PONG MASTER",
    url: "/games/pingpong/index.html",
    color: "#00ff88",
    image: "/games/pingpong/cover.png",
    orientation: "landscape",
  },
  {
    id: "poker",
...
<template>
  <main
    class="home-page"
    :style="{
      '--dynamic-glow': hoveredGame?.color || 'rgba(0, 255, 242, 0.5)',
    }"
  >
    <PixiBackground />
        ...
        <div v-if="activeGame" class="monitor-overlay" ref="monitorOverlay">
          <div class="monitor-container">
            <div
              ...
              :style="{
                'aspect-ratio':
                  activeGame.orientation === 'portrait' ? '9/16' : '16/9',
              }"
            >
