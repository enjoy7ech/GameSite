...
export const BALL_COLORS = {
    ...
    FIRE: 0xff8800,   // 炽热橙 (难度系数大幅提升)
    RAINBOW: 0xffffff // 彩虹球 (全奖励集成)
};
...
export const MESSAGES = {
    ...
    AIRBALL: "同步失效! 无效操作。",
    LEVEL_UP: "LEVEL UP!",
    LEVEL_INFO: (level, target) => `Level ${level === 7 ? "∞" : "0" + level} - 目标表现分: ${target === Infinity ? "∞ (无尽模式)" : target}`,
    RESULT_WIN: "挑战成功！数据已同步。",
...
export const LEVELS = [
    ...
    { target: 2000, time: 45 },
    { target: 5000, time: 40 },
    { target: 20000, time: 40 },
    { target: Infinity, time: 40 }
];
